...
class AuthorizationApi
{
     ...
     * @param  string $username username. Required for grant_type https://nl2go.com/jwt (optional)
     * @param  string $password password. Required for grant_type https://nl2go.com/jwt (optional)
     * @param  string $refresh_token refresh_token. Required for grant_type https://nl2go.com/jwt_refresh (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\Token
     */
    public function getToken($grant_type, $username = null, $password = null, $refresh_token = null)
    {
        list($response) = $this->getTokenWithHttpInfo($grant_type, $username, $password, $refresh_token);
        return $response;
    }
     ...
     */
    public function getTokenWithHttpInfo($grant_type, $username = null, $password = null, $refresh_token = null)
    {
        $returnType = '\Swagger\Client\Model\Token';
        $request = $this->getTokenRequest($grant_type, $username, $password, $refresh_token);
     ...
     */
    public function getTokenAsync($grant_type, $username = null, $password = null, $refresh_token = null)
    {
        return $this->getTokenAsyncWithHttpInfo($grant_type, $username, $password, $refresh_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTokenAsyncWithHttpInfo($grant_type, $username = null, $password = null, $refresh_token = null)
    {
        $returnType = '\Swagger\Client\Model\Token';
        $request = $this->getTokenRequest($grant_type, $username, $password, $refresh_token);
     ...
     */
    protected function getTokenRequest($grant_type, $username = null, $password = null, $refresh_token = null)
    {
