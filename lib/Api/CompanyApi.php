...
class CompanyApi
{
     ...
     */
    protected function getCompanyRequest()
    {
     ...
     * update the Company
     *
     * @param  string $id the id of the Company (required)
     * @param  \Swagger\Client\Model\CompanyPatch $company the data to update (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->updateCompanyWithHttpInfo($id, $company);
        return $response;
    }
     ...
     */
    public function updateCompanyWithHttpInfo($id, $company)
    {
        $returnType = '\Swagger\Client\Model\PatchResponse';
        $request = $this->updateCompanyRequest($id, $company);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCompanyAsync($id, $company)
    {
        return $this->updateCompanyAsyncWithHttpInfo($id, $company)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCompanyAsyncWithHttpInfo($id, $company)
    {
        $returnType = '\Swagger\Client\Model\PatchResponse';
        $request = $this->updateCompanyRequest($id, $company);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCompanyRequest($id, $company)
    {
