...
/**
 * AttributeGet Class Doc Comment
 *
 * @category Class
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AttributeGet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AttributeGet';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AttributeGet., must be smaller than or equal to 64.');
        }
     ...
     * Sets type
     *
     * @param string $type the type of the attribute ('number','date','boolean','text')
     *
     * @return $this
     */
     ...
     * Sets sub_type
     *
     * @param string $sub_type the sub_type of the attribute ('text','email','color','url','tel','date','datetime','time','integer','float')
     *
     * @return $this
     */
