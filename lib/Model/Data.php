...
class Data implements ModelInterface, ArrayAccess
{
     ...
     * Sets file
     *
     * @param string $file The file-hash returned in the the reponse of the init-Request before
     *
     * @return $this
     */
     ...
     * Sets associations
     *
     * @param object $associations a json object mapping the columns in the uploaded file to the columns in our system.<code>{\"0\": \"email\",\"1\":\"first_name\", \"2\":\"last_name\",\"3:\"custom_field\"}</code>
     *
     * @return $this
     */
