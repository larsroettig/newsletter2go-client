 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GroupGet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GroupGet';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GroupGet., must be smaller than or equal to 64.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling GroupGet., must be smaller than or equal to 1024.');
        }
