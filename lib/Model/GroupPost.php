 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GroupPost implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GroupPost';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['description']) && (strlen($this->container['description']) > 1024)) {
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['description']) > 1024) {
            return false;
        }
        return true;
    }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling GroupPost., must be smaller than or equal to 64.');
        }
    ...
    {
        if (!is_null($description) && (strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling GroupPost., must be smaller than or equal to 1024.');
        }
     ...
     * Sets list_id
     *
     * @param string $list_id the list id the group belongs to. Default_List of company is used if no list_id is submitted
     *
     * @return $this
     */
