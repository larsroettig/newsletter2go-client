...
class ImportGet implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ImportGet';
    ...
    protected static $swaggerTypes = [
        ...
        'count_updated' => 'int',
        'count_failed' => 'int',
        'duplicate_recipients' => '\Swagger\Client\Model\RecipientSimple[]',
        'invalid_recipients' => '\Swagger\Client\Model\RecipientSimple[]'
    ];
    ...
    protected static $setters = [
        'count_inserted' => 'setCountInserted',
        'count_updated' => 'setCountUpdated',
        'count_failed' => 'setCountFailed',
        'duplicate_recipients' => 'setDuplicateRecipients',
        'invalid_recipients' => 'setInvalidRecipients'
    ];
    ...
    protected static $getters = [
        'count_inserted' => 'getCountInserted',
        'count_updated' => 'getCountUpdated',
        'count_failed' => 'getCountFailed',
        'duplicate_recipients' => 'getDuplicateRecipients',
        'invalid_recipients' => 'getInvalidRecipients'
    ];
    ...
    {
        $this->container['count_inserted'] = isset($data['count_inserted']) ? $data['count_inserted'] : null;
        $this->container['count_updated'] = isset($data['count_updated']) ? $data['count_updated'] : null;
        $this->container['count_failed'] = isset($data['count_failed']) ? $data['count_failed'] : null;
        $this->container['duplicate_recipients'] = isset($data['duplicate_recipients']) ? $data['duplicate_recipients'] : null;
        $this->container['invalid_recipients'] = isset($data['invalid_recipients']) ? $data['invalid_recipients'] : null;
    }
     ...
     * @return int
     */
    public function getCountInserted()
    {
        return $this->container['count_inserted'];
    }

    /**
     * Sets count_inserted
     *
     * @param int $count_inserted the number of inserted recipients
     *
     * @return $this
     */
    public function setCountInserted($count_inserted)
    {
        $this->container['count_inserted'] = $count_inserted;
    ...
    {
        return $this->container['count_updated'];
    }

    /**
     * Sets count_updated
     *
     * @param int $count_updated the number of updated recipients
     *
     * @return $this
     */
    public function setCountUpdated($count_updated)
    {
        $this->container['count_updated'] = $count_updated;
     ...
     * Sets count_failed
     *
     * @param int $count_failed the number of failed recipients
     *
     * @return $this
     */
    ...
    /**
     * Gets duplicate_recipients
     *
     * @return \Swagger\Client\Model\RecipientSimple[]
     */
    public function getDuplicateRecipients()
    {
        return $this->container['duplicate_recipients'];
    }

    /**
     * Sets duplicate_recipients
     *
     * @param \Swagger\Client\Model\RecipientSimple[] $duplicate_recipients the recipients duplicated in the file
     *
     * @return $this
     */
    public function setDuplicateRecipients($duplicate_recipients)
    {
        $this->container['duplicate_recipients'] = $duplicate_recipients;

        return $this;
    }

    /**
     * Gets invalid_recipients
     *
     * @return \Swagger\Client\Model\RecipientSimple[]
     */
    public function getInvalidRecipients()
    {
        return $this->container['invalid_recipients'];
    }

    /**
     * Sets invalid_recipients
     *
     * @param \Swagger\Client\Model\RecipientSimple[] $invalid_recipients the recipients invalid in the file (like recipients with an invalid email-address
     *
     * @return $this
     */
    public function setInvalidRecipients($invalid_recipients)
    {
        $this->container['invalid_recipients'] = $invalid_recipients;
