 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ListPost implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListPost';
    ...
    public function setName($name)
    {
        if (!is_null($name) && (strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ListPost., must be smaller than or equal to 64.');
        }
    ...
    public function setImprint($imprint)
    {
        if (!is_null($imprint) && (strlen($imprint) > 256)) {
            throw new \InvalidArgumentException('invalid length for $imprint when calling ListPost., must be smaller than or equal to 256.');
        }
    ...
    public function setHeaderFromEmail($header_from_email)
    {
        if (!is_null($header_from_email) && (strlen($header_from_email) > 256)) {
            throw new \InvalidArgumentException('invalid length for $header_from_email when calling ListPost., must be smaller than or equal to 256.');
        }
    ...
    public function setHeaderFromName($header_from_name)
    {
        if (!is_null($header_from_name) && (strlen($header_from_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $header_from_name when calling ListPost., must be smaller than or equal to 128.');
        }
    ...
    public function setHeaderReplyEmail($header_reply_email)
    {
        if (!is_null($header_reply_email) && (strlen($header_reply_email) > 256)) {
            throw new \InvalidArgumentException('invalid length for $header_reply_email when calling ListPost., must be smaller than or equal to 256.');
        }
    ...
    public function setHeaderReplyName($header_reply_name)
    {
        if (!is_null($header_reply_name) && (strlen($header_reply_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $header_reply_name when calling ListPost., must be smaller than or equal to 128.');
        }
    ...
    public function setTrackingUrl($tracking_url)
    {
        if (!is_null($tracking_url) && (strlen($tracking_url) > 128)) {
            throw new \InvalidArgumentException('invalid length for $tracking_url when calling ListPost., must be smaller than or equal to 128.');
        }
