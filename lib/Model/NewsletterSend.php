...
class NewsletterSend implements ModelInterface, ArrayAccess
{
     ...
     * Sets scheduled
     *
     * @param string $scheduled ISO8601 timestamp for defining when the newsletter shall be send. If not set, the newsletter will be send immediatly
     *
     * @return $this
     */
     ...
     * Sets group_ids
     *
     * @param string[] $group_ids a list of group ids to which the newsletter gets send (If neither group_ids nor recipient_ids are given, the newsletter gets send to the whole list)
     *
     * @return $this
     */
     ...
     * Sets recipient_ids
     *
     * @param string[] $recipient_ids a list of recipient_ids ids to which the newsletter gets send (If group_ids is given, recipient_ids are ignored. If neither group_ids nor recipient_ids are given, the newsletter gets send to the whole list)
     *
     * @return $this
     */
     ...
     * Sets contexts
     *
     * @param object[] $contexts A list of contexts in which every context must have at least an email-address under recipient <code>{\"recipient\":{\"email\":\"...\"}}</code>.<br>Contexts are only allowed for mailings of type transaction
     *
     * @return $this
     */
