...
/**
 * RecipientPatch Class Doc Comment
 *
 * @category Class
 * @package     Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RecipientPatch implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RecipientPatch';
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (strlen($email) > 64)) {
            throw new \InvalidArgumentException('invalid length for $email when calling RecipientPatch., must be smaller than or equal to 64.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (strlen($phone) > 32)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling RecipientPatch., must be smaller than or equal to 32.');
        }
    ...
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (strlen($first_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling RecipientPatch., must be smaller than or equal to 64.');
        }
    ...
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (strlen($last_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling RecipientPatch., must be smaller than or equal to 64.');
        }
