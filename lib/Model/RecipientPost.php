 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RecipientPost implements ModelInterface, ArrayAccess
{
     ...
     * Sets list_id
     *
     * @param string $list_id the id of the list where the recipient should be added to. If no list_id is given, the default_list of the account is used
     *
     * @return $this
     */
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (strlen($email) > 64)) {
            throw new \InvalidArgumentException('invalid length for $email when calling RecipientPost., must be smaller than or equal to 64.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (strlen($phone) > 32)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling RecipientPost., must be smaller than or equal to 32.');
        }
    ...
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (strlen($first_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling RecipientPost., must be smaller than or equal to 64.');
        }
    ...
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (strlen($last_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling RecipientPost., must be smaller than or equal to 64.');
        }
