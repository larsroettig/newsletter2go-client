 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UserPatch implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserPatch';
     ...
     * Sets first_name
     *
     * @param string $first_name the first_name of the user
     *
     * @return $this
     */
